...
let carModels = [];
for (i=0; i < Object.values(inventory).length; i++) {
    carModels.push(Object.values(inventory)[i]['car_model'])
...
let carYears = [];
for (i=0; i < Object.values(inventory).length; i++) {
    carYears.push(Object.values(inventory)[i]['car_year'])
...
// let oldCars =[];
// for (i=0; i < Object.values(inventory).length; i++) {
//     if (Object.values(inventory)[i]['car_year'] < 2000) {
//         oldCars.push(Object.values(inventory)[i]['car_year']);
//     }
// } console.log(oldCars.length);

// ES6
let oldCars = carYears.filter(entry => entry < 2000);
console.log(oldCars);
...
// let BMWAndAudi =[];
// for (i=0; i < Object.values(inventory).length; i++) {
//     if (Object.values(inventory)[i]['car_make'] === 'BMW' || Object.values(inventory)[i]['car_make'] === 'Audi') {
//         BMWAndAudi.push(Object.values(inventory)[i]);
//     }
// } console.log(BMWAndAudi);

// ES6
let BMWAndAudi = inventory.filter(vehicle => vehicle.car_make === 'BMW' || vehicle.car_make === 'Audi');
